...
targetRoot = cwd + 'frames/size360_div12/'
inputRoot = cwd + 'gifs/size360_div12_s1_g32_nodither/'

def get_videoList(splitFile=cwd+'split/video_info_train.txt'):
    videoList = []
...
videoList_train = get_videoList(cwd+'split/video_info_train.txt')
videoList_valid = get_videoList(cwd+'split/video_info_valid.txt')
videoList_test  = get_videoList(cwd+'split/video_info_test.txt')
